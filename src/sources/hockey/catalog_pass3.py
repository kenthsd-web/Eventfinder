...
INPUT = DATA / "hockey_venues_unresolved_pass2_2026_27.json"
MANUAL_LOCATIONS = DATA / "hockey_manual_locations_pass3_2026_27.json"

CONTACT_CACHE = DATA / "hockey_swehockey_contacts_cache_2026_27.json"
GEO_CACHE = DATA / "hockey_geocode_cache_2026_27.json"

OUT_ADDED = DATA / "hockey_venues_added_pass3_2026_27.json"
OUT_UNRES = DATA / "hockey_venues_unresolved_pass3_2026_27.json"
OUT_OFFICIAL = DATA / "hockey_venue_official_addresses_pass3_2026_27.json"
OUT_SUMMARY = DATA / "hockey_catalog_pass3_summary_2026_27.json"
OUT_ZIP = DATA / "hockey_catalog_pass3_2026_27.zip"
...
def geocode_location(venue,loc,cache):
    if loc.get("lat") is not None and loc.get("lon") is not None:
        return {
            ...
            "query": "manual_verified_coordinates",
            "postcode_match": False,
            "city_score": 1.0,
            "venue_name_score": 1.0,
            "address_query": False,
    ...
    for q in queries:
        ...
        for r in arr:
            ...
            safe=(address_query and (postcode_ok or city_sc>=0.82)) or (venue_sc>=0.72 and city_sc>=0.72) or (venue_sc>=0.90 and postcode_ok)
...
def main():
    ...
    backup=DATA/"venue_catalog_before_hockey_catalog_pass3_2026_08_23.json"
    ...
    manual_locations=load_json(MANUAL_LOCATIONS,{})
    ...
    for item in items:
        venue=item.get("venue","").strip()
        loc=manual_locations.get(venue)
        if loc:
            loc={**loc}
        else:

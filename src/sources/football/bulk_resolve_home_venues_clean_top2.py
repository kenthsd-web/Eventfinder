...
DATA = ROOT / "data"
WORKLIST = DATA / "football_placeholder_by_home_team_clean_top2.json"
CATALOG = DATA / "venue_catalog.json"
STABLE = DATA / "football_stable_home_venues_clean_top2.json"
OUT_CANDIDATES = DATA / "football_bulk_source_candidates_clean_top2.json"
OUT_MISSING = DATA / "football_bulk_catalog_missing_clean_top2.json"
OUT_UNRESOLVED = DATA / "football_bulk_unresolved_clean_top2.json"
OUT_STATS = DATA / "football_bulk_resolver_stats_clean_top2.json"
OUT_REMAINING = DATA / "football_bulk_remaining_worklist_clean_top2.json"
OUT_RELINK = DATA / "football_bulk_relink_output_clean_top2.txt"
OUT_ZIP = DATA / "football_bulk_remaining_clean_top2.zip"
MATCH_MAP = DATA / "football_match_venues_clean_top2.json"
RELINKER = ROOT / "src" / "sources" / "football" / "__NO_RELINK_TOP2__.py"
